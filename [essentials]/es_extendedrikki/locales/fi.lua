Locales['fi'] = {
  ...
  -- Salary related
  ['received_salary'] = 'Palkkalaskelma: ~g~$%s~s~',
  ['received_help'] = 'Vastaanotit valtion tukea: ~g~$%s~s~',
  ['company_nomoney'] = 'yritys jolle teet töitä on köyhä eikä voi maksaa palkkaasi.',
  ['received_paycheck'] = 'sait palkan',
  ['bank:transfer'] = 'Mazebank:transfer',
  ...
  --MK2
  ['weapon_snspistol_mk2'] = 'pienpistooli mk2',
  ['weapon_revolver_mk2'] = 'raskas revolveri mk2',
  ['weapon_specialcarabine_mk2'] = 'G86C mk2',
  ['weapon_bullpuprifle_mk2'] = 'bullpup kivääri mk2',
  ['weapon_pumpshotgun_mk2'] = 'pumppuhaulikko mk2',
  ['weapon_marksmanrifle_mk2'] = 'marksman kivääri mk2',
  ['weapon_assaultrifle_mk2'] = 'AK47 MK2',
  ['weapon_carbinerifle_mk2'] = 'm4 mk2',
  ['weapon_heavysniper_mk2'] = 'raskas tarkkuuskivääri mk2'	,
  ['weapon_pistol_mk2'] = 'pistooli mk2',
  ['weapon_smg_mk2'] = 'smg mk2',
  ['weapon_combatmg_mk2'] = 'isopyssy mk2',
