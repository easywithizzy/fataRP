Config.Weapons = {
	...
	{name = 'WEAPON_SNSPISTOL_MK2',	label = _U('weapon_snspistol_mk2'),	components = {}	},	
	{name = 'WEAPON_REVOLVER_MK2',label = _U('weapon_revolver_mk2'),components = {}	},	
	{name = 'WEAPON_SPECIALCARBINE_MK2',label = _U('weapon_specialcarabine_mk2'),components = {}},	
	{name = 'WEAPON_BULLPUPRIFLE_MK2',label = _U('weapon_bullpruprifle_mk2'),components = {}},	
	{name = 'WEAPON_PUMPSHOTGUN_MK2',label = _U('weapon_pumpshotgun_mk2'),components = {}},		
	{name = 'WEAPON_MARKSMANRIFLE_MK2',label = _U('weapon_marksmanrifle_mk2'),components = {}},	
	{name = 'WEAPON_ASSAULTRIFLE_MK2',label = _U('weapon_assaultrifle_mk2'),components = {}},
	{name = 'WEAPON_CARBINERIFLE_MK2',label = _U('weapon_carbinerifle_mk2'),components = {}},
	{name = 'WEAPON_HEAVYSNIPER_MK2',label = _U('weapon_heavysniper_mk2'),components = {}},
	{name = 'WEAPON_PISTOL_MK2',label = _U('weapon_pistol_mk2'),components = {}},
	{name = 'WEAPON_SMG_MK2',label = _U('weapon_smg_mk2'),components = {}},
	{name = 'WEAPON_COMBATMG_MK2',label = _U('weapon_combatmg_mk2'),components = {}},	
