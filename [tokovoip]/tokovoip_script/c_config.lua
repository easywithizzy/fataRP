TokoVoipConfig = {
	...
	keySwitchChannels = Keys["N"], -- Keybind used to switch the radio channels
	...
	radioClickMaxChannel = 99.9, -- Set the max amount of radio channels that will have local radio clicks enabled
	...
	plugin_data = {
		...
		TSChannel = "Timantilla",
		TSPassword = "Timantillaonkivaa", -- TeamSpeak channel password (can be empty)
		...
		TSServer = "185.223.28.64:9064", -- TeamSpeak server address to be displayed on blocking screen
		...
		localName = "Pelaaja", -- If set, this name will be used as the user's teamspeak display name
