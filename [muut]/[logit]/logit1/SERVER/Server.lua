...
-- System Infos
PerformHttpRequest(DiscordWebhookSystemInfos, function(Error, Content, Head) end, 'POST', json.encode({username = SystemName, content = '**Palvelin käynnistyy**'}), { ['Content-Type'] = 'application/json' })

AddEventHandler('playerConnecting', function()
	TriggerEvent('DiscordBot:ToDiscord', DiscordWebhookSystemInfos, SystemName, '```css\n' .. GetPlayerName(source) .. ' yhdistää palvelimelle\n```', SystemAvatar, false)
end)

AddEventHandler('playerDropped', function(Reason)
	TriggerEvent('DiscordBot:ToDiscord', DiscordWebhookSystemInfos, SystemName, '```fix\n' .. GetPlayerName(source) .. ' poistu palvelimelta (' .. Reason .. ')\n```', SystemAvatar, false)
end)
...
AddEventHandler('DiscordBot:playerDied', function(Message, Weapon)
	...
	if Weapon then
		Message = ' **Pelaaja:** ' .. Message .. ' **Ase / Syy:** `[' .. Weapon .. ']` '
	end
