...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('sheriff',0,'recruit','Apulaisseriffi',300,'{}','{}'),
	('sheriff',1,'officer','Majuri',400,'{}','{}'),
	('sheriff',2,'sergeant','Eversti',500,'{}','{}'),
	('sheriff',3,'lieutenant','Pää Apulaisseriffi',550,'{}','{}'),
	('sheriff',4,'boss','Johtaja',600,'{}','{}')
;
