  ...
  if Config.EnableSocietyOwnedVehicles then
    ...
    ESX.TriggerServerCallback('tac_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_spawner', {
          ...
          TriggerServerEvent('tac_society:removeVehicleFromGarage', 'unicorn', vehicleProps)
        end, function(data, menu)
  ...
  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'unicorn_actions', {
      ...
      if data.current.value == 'menu_crafting' then
          ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'menu_crafting', {
                ...
                TriggerServerEvent('tac_unicornjob:craftingCoktails', data2.current.value)
  ...
  ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'billing', {
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('tac_billing:sendBill', GetPlayerServerId(player), 'society_unicorn', _U('billing'), amount)
        end
      else
...
function OpenGetStocksMenu()
  ESX.TriggerServerCallback('tac_unicornjob:getStockItems', function(items)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
        ...
        ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
            ...
            if count == nil then
              ...
              TriggerServerEvent('tac_unicornjob:getStockItem', itemName, count)
            end
          end, function(data2, menu2)
            menu2.close()
          end)
...
function OpenPutStocksMenu()
    ESX.TriggerServerCallback('tac_unicornjob:getPlayerInventory', function(inventory)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
        ...
        ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
            ...
            if count == nil then
              ...
              TriggerServerEvent('tac_unicornjob:putStockItems', itemName, count)
            end
          end, function(data2, menu2)
            menu2.close()
          end)
...
function OpenGetFridgeStocksMenu()
  ESX.TriggerServerCallback('tac_unicornjob:getFridgeStockItems', function(items)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'fridge_menu', {
        ...
        ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'fridge_menu_get_item_count', {
            ...
            if count == nil then
              ...
              TriggerServerEvent('tac_unicornjob:getFridgeStockItem', itemName, count)
            end
          end, function(data2, menu2)
            menu2.close()
          end)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'fridge_menu', {
        ...
        ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'fridge_menu_put_item_count', {
            ...
            if count == nil then
              ...
              TriggerServerEvent('tac_unicornjob:putFridgeStockItems', itemName, count)
            end
          end, function(data2, menu2)
            menu2.close()
          end)
...
function OpenGetWeaponMenu()
    ESX.TriggerServerCallback('tac_unicornjob:getVaultWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vault_get_weapon', {
        ...
        ESX.TriggerServerCallback('tac_unicornjob:removeVaultWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vault_put_weapon', {
      ...
      ESX.TriggerServerCallback('tac_unicornjob:addVaultWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
    end, function(data, menu)
      menu.close()
...
function OpenShopMenu(zone)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'unicorn_shop', {
            ...
            TriggerServerEvent('tac_unicornjob:buyItem', data.current.value, data.current.price, data.current.realLabel)
        end, function(data, menu)
            menu.close()
        end)
end
...
AddEventHandler('tac_unicornjob:hasEnteredMarker', function(zone)
...
AddEventHandler('tac_unicornjob:hasExitedMarker', function(zone)
    CurrentAction = nil
    ESX.UI.Menu.CloseAll()
end)
    ...
    while true do
        ...
        if IsJobTrue() then
            ...
            if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
                ...
                TriggerEvent('tac_unicornjob:hasEnteredMarker', currentZone)
            end

            if not isInMarker and HasAlreadyEnteredMarker then
                HasAlreadyEnteredMarker = false
                TriggerEvent('tac_unicornjob:hasExitedMarker', LastZone)
            end
        end
    end
end)
      ...
      if IsControlJustReleased(0,  38) and IsJobTrue() then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('tac_society:putVehicleInGarage', 'unicorn', vehicleProps)
          else
            if GetEntityModel(vehicle) == GetHashKey('rentalbus') then
              TriggerServerEvent('tac_service:disableService', 'unicorn')
            end
          end
        ...
        if CurrentAction == 'menu_boss_actions' and IsGradeBoss() then
          ...
          TriggerEvent('tac_society:openBossMenu', 'unicorn', function(data, menu)
...
-----------------------
----- TELEPORTERS -----
--[[AddEventHandler('tac_unicornjob:teleportMarkers', function(position)
  ...
  while true do
    ...
    if IsJobTrue() then
        ...
        if IsControlJustReleased(0, 38) and isInPublicMarker then
          TriggerEvent('tac_unicornjob:teleportMarkers', position)
        end
