Locales['en'] = {
  ...
  ['service_not'] = 'Et ole mennyt vuoroon! Käy vaatekaappilla.',
  ['service_anonunce'] = 'service information',
  ['service_in'] = 'Sinä menit vuoroon.',
  ['service_in_announce'] = 'operator ~y~%s~s~ has entered service!',
  ['service_out'] = 'Sinä lähdit vuorosta.',
  ['service_out_announce'] = 'Työntekijä ~y~%s~s~ poistui vuorosta.',
  -- Action Menu
  ...
  ['search'] = 'tutki',
  ['handcuff'] = 'Käsiraudat Päällä/Pois',
  ['drag'] = 'raahaa',
  ...
  ['being_searched'] = 'Sinun taskujasi tutkitaan ~b~Poliisin toimesta~s~',
  -- Vehicle interaction
