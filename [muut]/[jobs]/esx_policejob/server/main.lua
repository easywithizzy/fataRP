...
TriggerEvent('tac_phone:registerNumber', 'police', _U('alert_police'), true, true)
TriggerEvent('tac_society:registerSociety', 'police', 'Police', 'society_police', 'society_police', 'society_police', {type = 'public'})

RegisterServerEvent('tac_policejob:giveWeapon')
AddEventHandler('tac_policejob:giveWeapon', function(weapon, ammo)
...
RegisterServerEvent('tac_policejob:handcuff')
AddEventHandler('tac_policejob:handcuff', function(target)
	local xPlayer = ESX.GetPlayerFromId(source)

	if xPlayer.job.name == 'police' then
		TriggerClientEvent('tac_policejob:handcuff', target)
	else
...
ESX.RegisterServerCallback('tac_policejob:getOtherPlayerData', function(source, cb, target)
...
ESX.RegisterServerCallback('tac_policejob:getFineList', function(source, cb, category)
...
ESX.RegisterServerCallback('tac_policejob:getVehicleInfos', function(source, cb, plate)
...
ESX.RegisterServerCallback('tac_policejob:getVehicleFromPlate', function(source, cb, plate)
...
ESX.RegisterServerCallback('tac_policejob:getArmoryWeapons', function(source, cb)
...
ESX.RegisterServerCallback('tac_policejob:addArmoryWeapon', function(source, cb, weaponName, removeWeapon)
...
ESX.RegisterServerCallback('tac_policejob:removeArmoryWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('tac_policejob:buy', function(source, cb, amount)

	TriggerEvent('tac_addonaccount:getSharedAccount', 'society_police', function(account)
...
ESX.RegisterServerCallback('tac_policejob:getStockItems', function(source, cb)
	TriggerEvent('tac_addoninventory:getSharedInventory', 'society_police', function(inventory)
		cb(inventory.items)
	end)
end)

ESX.RegisterServerCallback('tac_policejob:getPlayerInventory', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
...
AddEventHandler('onResourceStop', function(resource)
	if resource == GetCurrentResourceName() then
		TriggerEvent('tac_phone:removeNumber', 'police')
	end
end)
