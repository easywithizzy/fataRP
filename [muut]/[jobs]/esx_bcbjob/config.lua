...
Config.Zones = {
	...
	Craft = {
		Pos   = { x = 100.61, y = 6617.06, z = 32.44 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 0, g = 183, b = 255 },
		Type  = 1
	},
	...
	VehicleSpawnPoint = {
		Pos   = { x = 110.43, y = 6606.14, z = 31.87 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = { x = 117.42, y = 6599.38, z = 32.01 },
	...
	Vehicledelivery:pay = {
		Pos   = { x = 1162.68, y = 2663.55, z = 37.97 },
