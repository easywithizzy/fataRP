...
TriggerEvent('tac_phone:registerNumber', 'ambulance', _U('alert_ambulance'), true, true)
...
ESX.RegisterServerCallback('tac_ambulancejob:removeItemsAfterRPDeath', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
...
if Config.EarlyRespawnFine then
	ESX.RegisterServerCallback('tac_ambulancejob:checkBalance', function(source, cb)
		local xPlayer = ESX.GetPlayerFromId(source)
		local bank:transferBalance = xPlayer.getAccount('bank:transfer').money

		cb(bank:transferBalance >= Config.EarlyRespawnFineAmount)
	end)
	...
	AddEventHandler('tac_ambulancejob:payFine', function()
		...
		TriggerClientEvent('tac:showNotification', xPlayer.source, _U('respawn_bleedout_fine_msg', ESX.Math.GroupDigits(fineAmount)))
		xPlayer.removeAccountMoney('bank:transfer', fineAmount)
	end)
end

ESX.RegisterServerCallback('tac_ambulancejob:getItemAmount', function(source, cb, item)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('tac_ambulancejob:buyJobVehicle', function(source, cb, vehicleProps, type)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('tac_ambulancejob:storeNearbyVehicle', function(source, cb, nearbyVehicles)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('tac_ambulancejob:getDeathStatus', function(source, cb)
