Locales['sv'] = {
  ...
  ['must_in_taxi:pay'] = 'du måste vara i en ~y~taxi:pay~s~ för att starta uppdraget.',
  ...
  ['inventory'] = 'inventory',
  ['taxi:pay_client'] = 'taxi:pay klient',
