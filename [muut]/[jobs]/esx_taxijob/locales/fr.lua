Locales['fr'] = {
  ...
  ['only_taxi:pay'] = 'vous ne pouvez ranger que les taxi:pay',

  ['taking_service'] = 'prise de service : taxi:pay/Uber',
  ...
  ['must_in_taxi:pay'] = 'vous devez être dans un taxi:pay pour commencer la mission',
  ...
  ['taxi:pay_client'] = 'client taxi:pay',
