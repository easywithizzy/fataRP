Locales['pl'] = {
  ...
  ['wear_work'] = 'strój pracownika taxi:pay',
  ...
  ['only_taxi:pay'] = 'możesz przechowywać tylko taksówki.',

  ['taking_service'] = 'przyjmowanie usługi: taxi:pay/Uber',
  ...
  ['must_in_taxi:pay'] = 'musisz być w taksówce aby rozpocząć misję',
  ...
  ['inventory'] = 'ekwipunek',
  ['taxi:pay_client'] = 'klient taksówki',
