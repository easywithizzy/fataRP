Locales['de'] = {
  ...
  ['only_taxi:pay'] = 'Du kannst nur taxi:pays parken.',

  ['taking_service'] = 'Service annehmen: taxi:pay/Uber',
  ...
  ['must_in_taxi:pay'] = 'Du musst in einem taxi:pays sein umd die Mission starten zu können',
  ...
  ['inventory'] = 'inventory',
  ['taxi:pay_client'] = 'taxi:pay Client',
