Locales['br'] = {
  ...
  ['only_taxi:pay'] = 'Você só pode guardar taxi:pays.',

  ['taking_service'] = 'Pegando serviço: taxi:pay/Uber',
  ...
  ['must_in_taxi:pay'] = 'Você deve estar em um táxi para começar a missão',
