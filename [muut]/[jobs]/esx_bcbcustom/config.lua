...
Config.Locale = 'fi'
Config.IsbcbJobOnly = true

Config.Zones = {

	ls1 = {
		Pos   = { x = 1174.63, y = 2639.47, z = 37.2},
		Size  = {x = 10.0, y = 10.0, z = 10},
		Color = {r = 204, g = 0, b = 0},
		Marker= 1,
		Name  = "bcb - Paja",
	...
	ls2 = {
		Pos   = { x = 110.17, y = 6627.03, z = 32.27},
		Size  = {x = 10.0, y = 10.0, z = 10.2},
		Color = {r = 204, g = 0, b = 0},
		Marker= 1,
		Name  = _U('bcb - Paja'),
		Hint  = _U('press_custom')
...
Config.Menus = {
	...
	modEngine = {
		...
		parent = 'upgrades',
		modType = 11,
		price = {4.95, 5.56, 8.12, 22.53}
	},
	modBrakes = {
		label = _U('brakes'),
		parent = 'upgrades',
		modType = 12,
		price = {4.65, 5.3, 9.6, 10.95}
	},
	modTransmission = {
		label = _U('transmission'),
		parent = 'upgrades',
		modType = 13,
		price = {3.95, 5.93, 10.51}
	},
	modSuspension = {
		label = _U('suspension'),
		parent = 'upgrades',
		modType = 15,
		price = {0.99, 2.44, 4.88, 6.77, 9.2}
	},
	modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
		modType = 16,
		price = {10.77, 20.28, 35.00, 40.00, 50.00, 65.00}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
