...
Config.Zones = {
	...
	ls1 = {
		Pos   = { x = -211.21, y = -1323.68, z = 30.89},
		Size  = {x = 10.0, y = 10.0, z = 10},
		Color = {r = 204, g = 0, b = 0},
		Marker= 1,
		Name  = "mekaanikon - Paja",
		Hint  = _U('press_custom')
    },

	ls2 = {
		Pos   = { x = -338.71, y = -134.65, z = 39.01},
		Size  = {x = 10.0, y = 10.0, z = 10.2},
		Color = {r = 204, g = 0, b = 0},
		Marker= 1,
		Name  = _U('mekaanikon - Paja'),
		Hint  = _U('press_custom')
	}
...
Config.Menus = {
	...
	modEngine = {
		...
		parent = 'upgrades',
		modType = 11,
		price = {3.95, 5.56, 6.12, 7.53}
	},
	modBrakes = {
		label = _U('brakes'),
		parent = 'upgrades',
		modType = 12,
		price = {1.2, 2.3, 3.6, 5.95}
	},
	modTransmission = {
	...
	modArmor = {
		...
		parent = 'upgrades',
		modType = 16,
		price = {9.95, 11.56, 15.12, 19.53}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
		modType = 17,
		price = {8.95, 11.56, 17.12, 18.53}
	},
	cosmetics = {
		label				= _U('cosmetics'),
		parent				= 'main',
