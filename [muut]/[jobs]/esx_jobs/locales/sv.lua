Locales['sv'] = {
  ...
  ['bank:transfer_deposit_returned']     = 'en deposition på ~g~%s SEK~s~ har återvänts till dig.',
  ['bank:transfer_deposit_taken']        = 'en deposition på ~r~%s SEK~s~ togs från dig.',
  ...
  ['delivery:pay_point']            = 'leveranspunkt',
  ['delivery:pay']                  = 'leverans',
