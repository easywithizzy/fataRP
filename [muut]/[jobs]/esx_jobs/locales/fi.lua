Locales['fi'] = {
  ...
  ['bank:transfer_deposit_returned']     = 'vakuuden summa ~g~€%s~s~ palautettiin sinulle.',
  ['bank:transfer_deposit_taken']        = 'vakuuden summa ~r~€%s~s~ otettiin sinulta.',
  ...
  ['delivery:pay_point']            = 'toimituspiste',
  ['delivery:pay']                  = 'toimitus',
