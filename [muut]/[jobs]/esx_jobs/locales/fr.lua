Locales['fr'] = {
  ...
  ['bank:transfer_deposit_returned']     = 'une caution de ~g~$%s~s~ vous a été rendue.',
  ['bank:transfer_deposit_taken']        = 'une caution de ~g~$%s~s~ vous a été prélevée.',
  ...
  ['delivery:pay_point']            = 'point de livraison',
  ['delivery:pay']                  = 'livraison',
