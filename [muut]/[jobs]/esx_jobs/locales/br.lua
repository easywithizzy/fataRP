Locales['br'] = {
  ...
  ['bank:transfer_deposit_returned']     = 'um depósito de segurança de ~g~$%s~s~ foi devolvido a você.',
  ['bank:transfer_deposit_taken']        = 'um depósito de segurança de ~g~$%s~s~ foi tirado de você.',
  ...
  ['delivery:pay_point']            = 'ponto de entrega',
  ['delivery:pay']                  = 'entrega',
