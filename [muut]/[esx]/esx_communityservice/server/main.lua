...
TriggerEvent('es:addGroupCommand', 'Yhdyskuntapalvelu', 'admin', function(source, args, user)
...
TriggerEvent('es:addGroupCommand', 'PoistaYhdyskuntapalvelu', 'admin', function(source, args, user)
	if args[1] then
