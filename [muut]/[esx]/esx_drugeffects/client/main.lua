...
--Lsd
RegisterNetEvent('tac_drugeffects:onLsd')
AddEventHandler('tac_drugeffects:onLsd', function()
...
RegisterNetEvent('tac_drugeffects:onBeer')
AddEventHandler('tac_drugeffects:onBeer', function()
