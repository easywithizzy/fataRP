...
function SetUnsetAccessory(accessory)
	ESX.TriggerServerCallback('tac_accessories:get', function(hasAccessory, accessorySkin)
	...
	TriggerEvent('tac_skin:openRestrictedMenu', function(data, menu)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'shop_confirm', {
			...
			if data.current.value == 'yes' then
				ESX.TriggerServerCallback('tac_accessories:checkMoney', function(hasEnoughMoney)
