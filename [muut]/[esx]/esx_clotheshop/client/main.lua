  ...
  ESX.UI.Menu.Open(
	...
	TriggerEvent('tac_skin:openRestrictedMenu', function(data, menu)
		...
		ESX.UI.Menu.Open(
			...
			function(data, menu)
				...
				if data.current.value == 'yes' then
					...
					ESX.TriggerServerCallback('tac_eden_clotheshop:checkMoney', function(hasEnoughMoney)
						...
						if hasEnoughMoney then
							...
							TriggerServerEvent('tac_eden_clotheshop:pay')

							HasPayed = true

							ESX.TriggerServerCallback('tac_eden_clotheshop:checkPropertyDataStore', function(foundStore)
											...
											if data2.current.value == 'yes' then
												...
												ESX.UI.Menu.Open(
													...
													function(data3, menu3)
														...
														TriggerEvent('skinchanger:getSkin', function(skin)
															TriggerServerEvent('tac_eden_clotheshop:saveOutfit', data3.value, skin)
														end)
      ...
      if data.current.value == 'player_dressing' then
        ...
        ESX.TriggerServerCallback('tac_eden_clotheshop:getPlayerDressing', function(dressing)
          ...
          ESX.UI.Menu.Open(
            ...
            function(data, menu)
              ...
              TriggerEvent('skinchanger:getSkin', function(skin)
                ...
                ESX.TriggerServerCallback('tac_eden_clotheshop:getPlayerOutfit', function(clothes)
	  ...
	  if data.current.value == 'suppr_cloth' then
		ESX.TriggerServerCallback('tac_eden_clotheshop:getPlayerDressing', function(dressing)
            ...
            function(data, menu)
			menu.close()
				TriggerServerEvent('tac_eden_clotheshop:deleteOutfit', data.current.value)
...
AddEventHandler('tac_eden_clotheshop:hasEnteredMarker', function(zone)
	CurrentAction     = 'shop_menu'
	CurrentActionMsg  = _U('press_menu')
	CurrentActionData = {}
end)

AddEventHandler('tac_eden_clotheshop:hasExitedMarker', function(zone)
...
Citizen.CreateThread(function()
	while true do
		...
		if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
			...
			TriggerEvent('tac_eden_clotheshop:hasEnteredMarker', currentZone)
		end

		if not isInMarker and HasAlreadyEnteredMarker then
			HasAlreadyEnteredMarker = false
			TriggerEvent('tac_eden_clotheshop:hasExitedMarker', LastZone)
		end
