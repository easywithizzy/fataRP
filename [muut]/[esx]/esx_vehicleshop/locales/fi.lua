Locales['fi'] = {
  ...
  ['shop_awaiting_model']     = 'Kuvastoa ~g~Ladataan~s~ odotahan rauhassa',
  ...
  ['sell_menu']               = '~b~Paina ~INPUT_CONTEXT~ jos haluat myydä ajoneuvosi %s saat siitä: ~g~%s€~s~',
  ...
  ['shop_menu']               = '~b~Paina ~INPUT_CONTEXT~ jos haluat katsoa autokaupan katalogia',
  ['generic_shopitem']        = '%s€',
  ['vehicle_dealer']          = 'Ajoneuvo - Autokauppa',
  ...
  ['vehicle_sold_for']        = 'Ajoneuvo ~b~%s~s~ on nyt ~y~myyty~s~ hintaan ~g~$%s~s~',
