...
ESX.RegisterServerCallback('tac_advancedgarage:getOwnedAircrafts', function(source, cb)
...
-- Fetch Owned Boats
ESX.RegisterServerCallback('tac_advancedgarage:getOwnedBoats', function(source, cb)
	local ownedBoats = {}
...
-- Fetch Owned Cars
ESX.RegisterServerCallback('tac_advancedgarage:getOwnedCars', function(source, cb)
	local ownedCars = {}
...
-- Store Vehicles
ESX.RegisterServerCallback('tac_advancedgarage:storeVehicle', function (source, cb, vehicleProps)
	local ownedCars = {}
...
ESX.RegisterServerCallback('tac_advancedgarage:getOutOwnedAircrafts', function(source, cb)
	local ownedAircrafts = {}
...
-- Fetch Pounded Boats
ESX.RegisterServerCallback('tac_advancedgarage:getOutOwnedBoats', function(source, cb)
	local ownedBoats = {}
...
-- Fetch Pounded Cars
ESX.RegisterServerCallback('tac_advancedgarage:getOutOwnedCars', function(source, cb)
	local ownedCars = {}
...
ESX.RegisterServerCallback('tac_advancedgarage:getOutOwnedAmbulanceCars', function(source, cb)
...
ESX.RegisterServerCallback('tac_advancedgarage:checkMoneyAircrafts', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('tac_advancedgarage:checkMoneyBoats', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('tac_advancedgarage:checkMoneyCars', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('tac_advancedgarage:checkMoneyAmbulance', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
