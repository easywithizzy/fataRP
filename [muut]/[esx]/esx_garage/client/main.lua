...
function ListOwnedCarsMenu()
	...
	ESX.TriggerServerCallback('tac_advancedgarage:getOwnedCars', function(ownedCars)
		if #ownedCars == 0 then
...
function ListOwnedBoatsMenu()
	...
	ESX.TriggerServerCallback('tac_advancedgarage:getOwnedBoats', function(ownedBoats)
...
function ListOwnedAircraftsMenu()
	...
	ESX.TriggerServerCallback('tac_advancedgarage:getOwnedAircrafts', function(ownedAircrafts)
...
function StoreOwnedCarsMenu()
	...
	if IsPedInAnyVehicle(playerPed,  false) then
		...
		ESX.TriggerServerCallback('tac_advancedgarage:storeVehicle', function(valid)
			if valid then
...
function ReturnOwnedCarsMenu()
	ESX.TriggerServerCallback('tac_advancedgarage:getOutOwnedCars', function(ownedCars)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'return_owned_car', {
			...
			ESX.TriggerServerCallback('tac_advancedgarage:checkMoneyCars', function(hasEnoughMoney)
...
function ReturnOwnedBoatsMenu()
	ESX.TriggerServerCallback('tac_advancedgarage:getOutOwnedBoats', function(ownedBoats)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'return_owned_boat', {
			...
			ESX.TriggerServerCallback('tac_advancedgarage:checkMoneyBoats', function(hasEnoughMoney)
				if hasEnoughMoney then
...
function ReturnOwnedAircraftsMenu()
	ESX.TriggerServerCallback('tac_advancedgarage:getOutOwnedAircrafts', function(ownedAircrafts)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'return_owned_aircraft', {
			...
			ESX.TriggerServerCallback('tac_advancedgarage:checkMoneyAircrafts', function(hasEnoughMoney)
				if hasEnoughMoney then
...
function ReturnOwnedAmbulanceMenu()
	ESX.TriggerServerCallback('tac_advancedgarage:getOutOwnedAmbulanceCars', function(ownedAmbulanceCars)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'return_owned_ambulance', {
			...
			ESX.TriggerServerCallback('tac_advancedgarage:checkMoneyAmbulance', function(hasEnoughMoney)
				if hasEnoughMoney then
	...
	if Config.UseBoatGarages then
		for k,v in pairs(Config.BoatGarages) do
			table.insert(blipList, {
				coords = { v.GaragePoint.x, v.GaragePoint.y },
				text   = _U('blip_boat'),
				sprite = Config.UseBoatGarage.Sprite,
				color  = Config.UseBoatGarage.Color,
				scale  = Config.UseBoatGarage.Scale
			})
		end
		...
		for k,v in pairs(Config.BoatPounds) do
			table.insert(blipList, {
				coords = { v.PoundPoint.x, v.PoundPoint.y },
				text   = _U('pound_boats'),
				sprite = Config.UseBoatPounds.Sprite,
				color  = Config.UseBoatPounds.Color,
				scale  = Config.UseBoatPounds.Scale
			})
		end
	end
