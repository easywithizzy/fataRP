...
AddEventHandler('skinchanger:modelLoaded', function()
	ESX.TriggerServerCallback('tac_tattooshop:requestPlayerTattoos', function(tattooList)
		if tattooList then
		...
		if data.current.value then
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'tattoo_shop_categories', {
				...
				if data2.current.value ~= nil then
					...
					ESX.TriggerServerCallback('tac_tattooshop:purchaseTattoo', function(success)
						if success then
