...
function CountCops()
	...
	for i=1, #xPlayers, 1 do
		...
		if xPlayer.job.name == 'police' or xPlayer.job.name == 'doa' or xPlayer.job.name == 'sheriff' then
...
AddEventHandler('lester:vendita', function()
	...
	xPlayer.addAccountMoney('black_money', math.random(2000,9000))
end)

ESX.RegisterServerCallback('tac_vangelico_robbery:conteggio', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
