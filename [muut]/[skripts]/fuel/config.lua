...
Config.Strings = {
	ExitVehicle = "Poistu ajoneuvosta tankataksesi",
	EToRefuel = "Paina ~g~E ~w~tankataksesi ajoveuvo",
	JerryCanEmpty = "Jerrykannu on tyhjä",
	FullTank = "Tankki on täysi",
	PurchaseJerryCan = "Paina ~g~E ~w~ostaaksesi jerrykannun hintaan ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Paina ~g~E ~w~peruttaaksesi tankkauksen",
	CancelFuelingJerryCan = "Paina ~g~E ~w~peruuttaaksesi tankkauksen",
	NotEnoughCash = "Ei tarpeeksi käteistä",
	RefillJerryCan = "Paina ~g~E ~w~ täyttääksesi jerrykannun ",
	NotEnoughCashJerryCan = "Ei tarpeeksi käteistä täyttääksesi jerrykannua",
	JerryCanFull = "Jerrykannu on täysi",
	TotalCost = "Hinta",
}
