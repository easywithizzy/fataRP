...
-- NOte this might cause an issue of the image getting stuck on peoples screens
	...
	MenuImage = "https://i.imgur.com/zY400F9.png",
...
Config.Languages = {
  ['en'] = {
        ['emotes'] = '~b~Animaatiot~s~',
        ['danceemotes'] = "🕺 ~b~Tanssi animaatiot~s~",
        ['propemotes'] = "📦 ~b~Tavara animaatiot~s~",
        ['favoriteemotes'] = "🌟 ~b~Suosikit~s~",
        ['favoriteinfo'] = "~b~Select an emote here to set it as your favorite.",
        ['rfavorite'] = "~b~Reset favorite",
        ['prop2info'] = "❓ ~b~Prop Emotes can be located at the end",
        ['set'] = "~b~Set (",
        ['setboundemote'] = "~b~) to be your bound emote?",
        ['newsetemote'] = "~b~~w~ is now your bound emote, press ~g~CapsLock~w~ to use it.",
        ['cancelemote'] = "~b~Lopeta animaatio~s~",
        ['cancelemoteinfo'] = "~b~X~w~ ~b~Cancels the currently playing emote",
        ['walkingstyles'] = "~b~Kävelytyylit~s~",
        ['resetdef'] = "~b~Reset to default",
        ['normalreset'] = "~b~Normal (Reset)",
        ['moods'] = "~b~Moods~s~",
        ['infoupdate'] = "~b~Information~s~",
        ['infoupdateav'] = "~b~Information (Update available)",
        ['infoupdateavtext'] = "~b~An update is available, get the latest version from ~y~https://github.com/andristum/dpemotes~w~",
        ['suggestions'] = "~b~Suggestions?",
        ['suggestionsinfo'] = "~b~'dullpear_dev' on FiveM forums for any feature/emote suggestions! ✉️",
        ['notvaliddance'] = "~b~is not a valid dance.",
        ['notvalidemote'] = "~b~is not a valid emote.",
        ['nocancel'] = "~b~No emote to cancel.",
        ['maleonly'] = "~b~This emote is male only, sorry!",
        ['emotemenucmd'] = "~b~Do /emotemenu for a menu.",
        ['shareemotes'] = "👫 ~b~Shared Emotes~s~",
        ['shareemotesinfo'] = "~b~Invite a nearby person to emote",
        ['sharedanceemotes'] = "🕺 ~b~Shared Dances",
        ['notvalidsharedemote'] = "~b~is not a valid shared emote.",
        ['sentrequestto'] = "~b~Sent request to ~y~",
        ['nobodyclose'] = "~b~Nobody ~b~close~w~ enough.",
        ['doyouwanna'] = "~b~~y~Y~w~ to accept, ~b~L~w~ to refuse (~g~",
        ['refuseemote'] = "~b~Emote refused.",
        ['makenearby'] = "~b~makes the nearby player play",
        ['camera'] = "~b~Press ~y~G~w~ to use camera flash.",
        ['makeitrain'] = "~b~Press ~y~G~w~ to make it rain.",
        ['pee'] = "~b~Hold ~y~G~w~ to pee.",
        ['spraychamp'] = "~b~Hold ~y~G~w~ to spray champagne",
        ['bound'] = "~b~Bound ",
        ['to'] = "~b~to",
        ['currentlyboundemotes'] = "~b~ Currently bound emotes:",
        ['notvalidkey'] = "~b~is not a valid key.",
        ['keybinds'] = "🔢 ~b~Keybinds~s~",
        ['keybindsinfo'] = "~b~Use"
  },
  ['fr'] = {
        ['emotes'] = 'Emotes',
        ...
        ['cancelemoteinfo'] = "~b~X~w~ Annule l'emote en cours de lecture",
  ...
  ['de'] = {
        ...
        ['doyouwanna'] = "~y~Y~w~ zu akzeptieren, ~b~L~w~ zu verweigern (~g~",
  ...
  ['sv'] = {
        ...
        ['cancelemoteinfo'] = "~b~X~w~ Avbryter det emote som för närvarande används.",
        ...
        ['nobodyclose'] = "Ingen ~b~nära~w~ tillräckligt.",
        ['doyouwanna'] = "~y~Y~w~ för att acceptera, ~b~L~w~ för att vägra (~g~",
  ...
  ['es'] = {
        ...
        ['cancelemoteinfo'] = "~b~X~w~ Cancela la animacion actual.",
