...
Citizen.CreateThread(function()
    ...
    FinanceOffice2.LoadDefault()    -- -75.8466, -826.9893, 243.3859 (Maze bank:transfer Building)
    FinanceOffice3.LoadDefault()    -- -1579.756, -565.0661, 108.523 (Lom bank:transfer)
    FinanceOffice4.LoadDefault()    -- -1392.667, -480.4736, 72.04217 (Maze bank:transfer West)
    ...
    ImportCEOGarage2.LoadDefault()             -- Maze bank:transfer Building               /!\ Do not load parts Garage1, Garage2 and Garage3 at the same time (overlaping issues)
    ImportCEOGarage3.LoadDefault()             -- Lom bank:transfer                         /!\ Do not load parts Garage1, Garage2 and Garage3 at the same time (overlaping issues)
    ImportCEOGarage4.LoadDefault()             -- Maze bank:transfer West                   /!\ Do not load parts Garage1, Garage2 and Garage3 at the same time (overlaping issues)
