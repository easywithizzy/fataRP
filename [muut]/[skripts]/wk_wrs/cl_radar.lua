...
Citizen.CreateThread( function()
    while true do 
        ...
        if ( ( (not inVeh or (inVeh and GetVehicleClass( veh ) ~= 18)) and radarEnabled and not hidden) or IsPauseMenuActive() and radarEnabled or IsEntityPlayingAnim(GetPlayerPed(-1), 'anim@cellphone@in_car@ps', 'cellphone_text_in', 3) ) then 
            hidden = true 
...
--[[------------------------------------------------------------------------
    ...
    Thanks to the authors of the ES bank:transfering script. 
------------------------------------------------------------------------]]--
local locked = false 
