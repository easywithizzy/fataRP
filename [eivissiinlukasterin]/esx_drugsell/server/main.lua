...
AddEventHandler('sellDrugs', function()
	...
	local opiuqtySingle = xPlayer.getInventoryItem('heroin').count
	local x = 0
	local blackMoney = 0
	local drugType = nil
	...
	TriggerClientEvent('tac:showNotification', _source, _U('you_have_sold') .. '~b~'..x..'~w~' .. _U(drugtype) .. blackMoney .. '$')
end)
...
AddEventHandler('check', function()
	...
	if cops >= Config.CopsRequiredToSell then
		...
		TriggerClientEvent('tac:showNotification', _source, _U('must_be') .. Config.CopsRequiredToSell .. _U('to_sell_drugs'))
	end
end)
...
AddEventHandler('drugsInProgress', function(street1, street2, sex)
      --TriggerClientEvent("outlawNotify", -1, "~r~Huumeiden myynti ~w~"..sex.."~r~lähellä~w~"..street1.."~r~ and ~w~"..street2)
	TriggerClientEvent("outlawNotify", -1, "~r~Huumeiden myynti ~w~"..sex.." ~r~kadulla ~w~"..street1.."~r~ a ~w~"..street2)
end)
...
AddEventHandler('drugsInProgressS1', function(street1, sex)
      --TriggerClientEvent("outlawNotify", -1, "~r~Huumeiden myynti ~w~"..sex.."~r~lähellä~w~"..street1)
	TriggerClientEvent("outlawNotify", -1, "~r~Huumeiden myynti ~w~"..sex.." ~r~kadulla ~w~"..street1)
end)
