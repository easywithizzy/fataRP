...
RegisterNetEvent('tac_attachments_bleiker:extmag')
AddEventHandler('tac_attachments_bleiker:extmag', function(duration)
				local inventory = ESX.GetPlayerData().inventory
				local extmag = 0
					for i=1, #inventory, 1 do
					  if inventory[i].name == 'extmag' then
						extmag = inventory[i].count
					  end
					end
...
RegisterNetEvent('tac_attachments_bleiker:kompensator')
AddEventHandler('tac_attachments_bleiker:kompensator', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local kompensator = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('tac_attachments_bleiker:MountedScope')
AddEventHandler('tac_attachments_bleiker:MountedScope', function(duration)
					local inventory = ESX.GetPlayerData().inventory
...
RegisterNetEvent('tac_attachments_bleiker:yusuf')
AddEventHandler('tac_attachments_bleiker:yusuf', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local yusuf = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('tac_attachments_bleiker:celownikdluga')
AddEventHandler('tac_attachments_bleiker:celownikdluga', function(duration)
					local inventory = ESX.GetPlayerData().inventory
...
RegisterNetEvent('tac_attachments_bleiker:vipskinmotyl')
AddEventHandler('tac_attachments_bleiker:vipskinmotyl', function(duration)
					local inventory = ESX.GetPlayerData().inventory
...
RegisterNetEvent('tac_attachments_bleiker:kastetpink')
AddEventHandler('tac_attachments_bleiker:kastetpink', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local kastetpink = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('tac_attachments_bleiker:mediumscope')
AddEventHandler('tac_attachments_bleiker:mediumscope', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local mediumscope = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('tac_attachments_bleiker:largescope')
AddEventHandler('tac_attachments_bleiker:largescope', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local largescope = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('tac_attachments_bleiker:holografik')
AddEventHandler('tac_attachments_bleiker:holografik', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local holografik = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('tac_attachments_bleiker:platin50')
AddEventHandler('tac_attachments_bleiker:platin50', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local platin50 = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('tac_attachments_bleiker:woodheavyp')
AddEventHandler('tac_attachments_bleiker:woodheavyp', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local woodheavyp = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('tac_attachments_bleiker:wooddlugie')
AddEventHandler('tac_attachments_bleiker:wooddlugie', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local wooddlugie = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('tac_attachments_bleiker:czaszkidlugie')
AddEventHandler('tac_attachments_bleiker:czaszkidlugie', function(duration)
					local inventory = ESX.GetPlayerData().inventory
    ...
    local currentWeaponHash = GetSelectedPedWeapon(ped)
		if used14 <= czaszkidlugie then
			...
			if currentWeaponHash == GetHashKey("WEAPON_SNSPISTOL_MK2") then
				   ...
				   elseif currentWeaponHash == GetHashKey("WEAPON_PISTOL_MK2") then
					GiveWeaponComponentToPed(GetPlayerPed(-1), GetHashKey("WEAPON_PISTOL_MK2"), GetHashKey("COMPONENT_PISTOL_MK2_CAMO_11"))  
					ESX.ShowNotification(_U('equip')) 
					used14 = used14 + 1
				elseif currentWeaponHash == GetHashKey("WEAPON_SMG_MK2") then
...
RegisterNetEvent('tac_attachments_bleiker:zebradlugie')
AddEventHandler('tac_attachments_bleiker:zebradlugie', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local zebradlugie = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('tac_attachments_bleiker:boomdlugie')
AddEventHandler('tac_attachments_bleiker:boomdlugie', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local boomdlugie = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('tac_attachments_bleiker:tactitalmuzle')
AddEventHandler('tac_attachments_bleiker:tactitalmuzle', function(duration)
					local inventory = ESX.GetPlayerData().inventory
...
RegisterNetEvent('tac_attachments_bleiker:kastetpimp')
AddEventHandler('tac_attachments_bleiker:kastetpimp', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local kastetpimp = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('tac_attachments_bleiker:kastetbalas')
AddEventHandler('tac_attachments_bleiker:kastetbalas', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local kastetbalas = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('tac_attachments_bleiker:kastetdollar')
AddEventHandler('tac_attachments_bleiker:kastetdollar', function(duration)
					local inventory = ESX.GetPlayerData().inventory
...
RegisterNetEvent('tac_attachments_bleiker:kastetdiament')
AddEventHandler('tac_attachments_bleiker:kastetdiament', function(duration)
					local inventory = ESX.GetPlayerData().inventory
...
RegisterNetEvent('tac_attachments_bleiker:kastethate')
AddEventHandler('tac_attachments_bleiker:kastethate', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local kastethate = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('tac_attachments_bleiker:kastetplayer')
AddEventHandler('tac_attachments_bleiker:kastetplayer', function(duration)
					local inventory = ESX.GetPlayerData().inventory
...
RegisterNetEvent('tac_attachments_bleiker:kastetvagos')
AddEventHandler('tac_attachments_bleiker:kastetvagos', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local kastetvagos = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('tac_attachments_bleiker:grip')
AddEventHandler('tac_attachments_bleiker:grip', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local grip = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('tac_attachments_bleiker:suppressor')
AddEventHandler('tac_attachments_bleiker:suppressor', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local suppressor = 0
					for i=1, #inventory, 1 do
...
RegisterNetEvent('tac_attachments_bleiker:flashlight')
AddEventHandler('tac_attachments_bleiker:flashlight', function(duration)
					local inventory = ESX.GetPlayerData().inventory
				local flashlight = 0
					for i=1, #inventory, 1 do
...
AddEventHandler('playerSpawned', function()	-- nolla käytöt connectaessa, jotta voi käyttää uudelleen
        used = 0
        used2 = 0
        used3 = 0
	used4 = 0
...
AddEventHandler('tac:onPlayerDeath', function() -- "nollaa käytöt" kuollessa, jotta voi käyttää uudelleen
        used = 0
        used2 = 0
        used3 = 0
	used4 = 0
