...
--//Police//---
RegisterNetEvent('tac_tracker:updatePolice')
AddEventHandler('tac_tracker:updatePolice',function(policetable,name,showblips)
...
--//Ambulance//---
RegisterNetEvent('tac_tracker:updateAmbulance')
AddEventHandler('tac_tracker:updateAmbulance',function(ambulancetable,name,showblips)
