...
---//Ambulance//---
-------------------------------------------------------------------
RegisterServerEvent('tac_tracker:addAmbulanceToTable')
AddEventHandler('tac_tracker:addAmbulanceToTable',function()
	...
	getIdentity(identifier, function(data)
		...
		showblips = true
		TriggerClientEvent('tac_tracker:updateAmbulance',-1,ambulancetable,i,showblips)
	end)
end)


RegisterServerEvent('tac_tracker:removeAmbulanceFromTable')
AddEventHandler('tac_tracker:removeAmbulanceFromTable',function()
...
---//Police//---
RegisterServerEvent('tac_tracker:addPoliceToTable')
AddEventHandler('tac_tracker:addPoliceToTable',function()
	local xPlayer = ESX.GetPlayerFromId(source)
	local identifier = xPlayer.getIdentifier()
	local i = GetPlayerName(source) 
	...
	getIdentity(identifier, function(data)
		...
		showblips = true
		TriggerClientEvent('tac_tracker:updatePolice',-1,policetable,i,showblips)
	end)
end)


RegisterServerEvent('tac_tracker:removePoliceFromTable')
AddEventHandler('tac_tracker:removePoliceFromTable',function()
